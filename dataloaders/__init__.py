...
def make_data_loader(args, **kwargs):
    ...
    if val_list is not None:
        ...
        val_loader = DataLoader(val_set, batch_size=args.gpus, shuffle=False,drop_last = True, **kwargs)
    else:
        val_set = None
        val_loader = None
    ...
    if test_list is not None:
        ...
        test_loader = DataLoader(test_set, batch_size=args.gpus, shuffle=False,drop_last = True, **kwargs)
    else:
        test_set = None
        test_loader = None
    if 'rank' in args:
