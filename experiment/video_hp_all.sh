...
SAVE_DIR=/mnt/lustre/wuyao/Data/segmentation_pytorch_model/humanparse_257/$DATASET_SAVE/$BACKBONE/$EXPERIMENT/test_$DATASET_TRAIN
RESUME=/mnt/lustre/wuyao/Data/segmentation_pytorch_model/humanparse_257/$DATASET_TRAIN/$BACKBONE/$EXPERIMENT/best.pth.tar
NUM_CLASSES=2
BATCH_SIZE=1
CROP_SIZE=257
SHRINK=16
