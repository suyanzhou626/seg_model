...
BN = None
BLOCK_PARAMETER=[{'layers':3,'planes':[3,24,24,24],'k_sizes':[7,3,3],'strides':[4,1,1],'pads':[3,1,1],'dilations':[1,1,1]},
                 {'layers':3,'planes':[24,48,48,48],'k_sizes':[3,3,3],'strides':[2,1,1],'pads':[1,1,1],'dilations':[1,1,1]},
                 {'layers':3,'planes':[48,96,96,96],'k_sizes':[3,3,3],'strides':[2,1,1],'pads':[1,1,1],'dilations':[1,1,1]},
                 {'layers':3,'planes':[96,192,192,192],'k_sizes':[3,3,3],'strides':[2,1,1],'pads':[1,1,1],'dilations':[1,1,1]},
                 {'layers':3,'planes':[192,192,192,192],'k_sizes':[3,3,3],'strides':[1,1,1],'pads':[1,1,1],'dilations':[1,1,1]}]
