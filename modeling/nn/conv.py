...
class Conv2d(Module):
    # this class is add maxpoolint layer before dilation conv operation to capture partial information
    def __init__(self,in_channels,out_channels,kernel_size,stride=1,padding=0,dilation=1,
                groups=1,bias=True):
        super().__init__()
        self.pooling_size = dilation - 1 + dilation % 2
        self.conv = old_conv(in_channels,out_channels,kernel_size,stride,padding,
